...
//                console.log(cla + '--' + valueColToNum + 'claa' + cla);
            ...
            $(document).on("click", ".image-manager .img-link", function (e) {
                ...
                if(widget == "ApImage360")
                {
                    ...
                    html += '    <img data-position="" data-name="' +$(img).attr("data-name")+ '" class="img-thumbnail" src="' + name + '">';
                    html += '    <input type="hidden" value="' +$(img).attr("data-name")+ '" class="ApImage360" id="'+image_name+'" name="'+image_name+'">';
                    html += '</div>';
