...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57b3dd3ece99e6_37217995',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57b3dd3ece99e6_37217995')) {function content_57b3dd3ece99e6_37217995($_smarty_tpl) {?>
<!-- Block suppliers module -->
<div id="suppliers_block_left" class="block blocksupplier">
	<h4 class="title_block">
					<a href="http://parissara.com/es/supplier" title="Proveedores">
					Proveedores
					</a>
			</h4>
	<div class="block_content">
								<ul class="list-block list-group bullet">
											<li class="last_item">
                					<a 
					href="http://parissara.com/es/1__fashion-supplier" 
					...
					<div class="form-group">
						<select class="form-control" name="supplier_list">
							<option value="0">Todos los proveedores</option>
													<option value="http://parissara.com/es/1__fashion-supplier">Fashion Supplier</option>
												</select>
					</div>
				</form>
						</div>
