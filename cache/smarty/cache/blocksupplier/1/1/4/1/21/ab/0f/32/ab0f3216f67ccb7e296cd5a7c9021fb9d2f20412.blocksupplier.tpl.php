...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57ba22a366b340_64137725',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ba22a366b340_64137725')) {function content_57ba22a366b340_64137725($_smarty_tpl) {?>
<!-- Block suppliers module -->
<div id="suppliers_block_left" class="block blocksupplier">
	<h4 class="title_block">
					<a href="http://parissara.com/br/supplier" title="Fornecedores">
					Fornecedores
					</a>
			</h4>
	<div class="block_content">
								<ul class="list-block list-group bullet">
											<li class="last_item">
                					<a 
					href="http://parissara.com/br/1__fashion-supplier" 
					title="Mais sobre Fashion Supplier">
				                Fashion Supplier
                					</a>
                				</li>
										</ul>
					...
					<div class="form-group">
						<select class="form-control" name="supplier_list">
							<option value="0">Todos os fornecedores</option>
													<option value="http://parissara.com/br/1__fashion-supplier">Fashion Supplier</option>
												</select>
					</div>
				</form>
						</div>
