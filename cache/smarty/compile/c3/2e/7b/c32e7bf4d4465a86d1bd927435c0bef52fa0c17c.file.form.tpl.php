<?php /* Smarty version Smarty-3.1.19, created on 2016-09-10 12:24:40
         compiled from "/home/paris/public_html/parissara_com/modules/leoslideshow/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:35457285857d433c8168af1-73697622%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c32e7bf4d4465a86d1bd927435c0bef52fa0c17c' => 
    array (
      0 => '/home/paris/public_html/parissara_com/modules/leoslideshow/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1470921372,
      2 => 'file',
    ),
    '5ac16f4f77ace53ab8008e09796b6d78b3c91552' => 
    array (
      0 => '/home/paris/public_html/parissara_com/iadmin/themes/default/template/helpers/form/form.tpl',
      1 => 1470921293,
      2 => 'file',
    ),
    '8cf40aa47aeb7b200509433b5c7c06d34a921bc7' => 
    array (
      0 => '/home/paris/public_html/parissara_com/iadmin/themes/default/template/helpers/form/form_group.tpl',
      1 => 1470921293,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '35457285857d433c8168af1-73697622',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d433c931f489_09791405',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d433c931f489_09791405')) {function content_57d433c931f489_09791405($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/paris/public_html/parissara_com/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_replace')) include '/home/paris/public_html/parissara_com/tools/smarty/plugins/modifier.replace.php';
?>
...
" width="50" class="<?php if (!$_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']]) {?>nullimg<?php }?>" alt="" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['psBaseModuleUri']->value, ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true);?>
"/>
                            <input id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
" type="hidden" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
" class="hide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true);?>
" />
                            <br>
                            <a onclick="image_upload('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
', 'thumb_slider_thumbnail_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
');" href="javascript:void(0);"><?php echo smartyTranslate(array('s'=>'Browse','mod'=>'leoslideshow'),$_smarty_tpl);?>
</a>&nbsp;&nbsp;|&nbsp;&nbsp;
...
').addClass('nullimg'); $('#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
').attr('value', '');" href="javascript:void(0);"><?php echo smartyTranslate(array('s'=>'Clear','mod'=>'leoslideshow'),$_smarty_tpl);?>
</a>
                        </div>
                        <br/>
                    </div>
...
" class="hide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value["image"][$_smarty_tpl->tpl_vars['language']->value['id_lang']], ENT_QUOTES, 'UTF-8', true);?>
" />
            <?php } ?>
        </div>
		</div>
...
" width="50" class="<?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp1=ob_get_clean();?><?php if (!$_tmp1) {?>nullimg<?php }?>" alt="<?php echo smartyTranslate(array('s'=>'Group Back-ground','mod'=>'leoslideshow'),$_smarty_tpl);?>
" src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['psBaseModuleUri']->value, ENT_QUOTES, 'UTF-8', true);?>
...
" type="hidden" name="group[background_url]" class="hide" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true);?>
" />
               <br>
...
', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['psBaseModuleUri']->value, ENT_QUOTES, 'UTF-8', true);?>
');" href="javascript:void(0);"><?php echo smartyTranslate(array('s'=>'Browse','mod'=>'leoslideshow'),$_smarty_tpl);?>
</a>&nbsp;&nbsp;|&nbsp;&nbsp;
...
').attr('value', '');" href="javascript:void(0);"><?php echo smartyTranslate(array('s'=>'Clear','mod'=>'leoslideshow'),$_smarty_tpl);?>
            ...
            <p><?php echo smartyTranslate(array('s'=>'Click to upload or select a back-ground','mod'=>'leoslideshow'),$_smarty_tpl);?>
</p>
        </div>
    <?php }?>
        ...
        <div class="form-group">
            <div class="col-lg-9 col-lg-offset-3">
                <div class="btn-group pull-right">
                    <a class="btn btn-default <?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>dropdown-toggle <?php } else { ?>group-preview <?php }?>color_danger" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['previewLink']->value, ENT_QUOTES, 'UTF-8', true);?>
...
?>
                        <li>
                            <?php $_smarty_tpl->tpl_vars['arrayParam'] = new Smarty_variable(array('secure_key'=>$_smarty_tpl->tpl_vars['msecure_key']->value,'id_group'=>intval($_smarty_tpl->tpl_vars['input']->value['id_group'])), null, 0);?>
...
" class="group-preview">
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
                ...
                <button class="btn btn-default dash_trend_right" name="submitGroup" id="module_form_submit_btn" type="submit">
                        <i class="icon-save"></i> <?php echo smartyTranslate(array('s'=>'Save','mod'=>'leoslideshow'),$_smarty_tpl);?>
...
"><i class="icon-film"></i> <?php echo smartyTranslate(array('s'=>'Manages Sliders','mod'=>'leoslideshow'),$_smarty_tpl);?>
                ...
                <a class="btn btn-default" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['exportLink']->value, ENT_QUOTES, 'UTF-8', true);?>
&id_group=<?php echo intval($_smarty_tpl->tpl_vars['input']->value['id_group']);?>
"><i class="icon-eye-open"></i> <?php echo smartyTranslate(array('s'=>'Export Group and sliders','mod'=>'leoslideshow'),$_smarty_tpl);?>
</a>
...
" class="delete">
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='sperator_form') {?>
        <div class="<?php if (isset($_smarty_tpl->tpl_vars['input']->value['class'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?>alert alert-info<?php }?>" 
			 <?php if (isset($_smarty_tpl->tpl_vars['input']->value['name'])) {?>name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
"<?php }?>
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['defaultFormLanguage']->value) {?>style="display:none"<?php }?>>
                    ...
                    <div class="col-lg-9">
                        <div class="radiolabel">
                            <lable><?php echo smartyTranslate(array('s'=>'Video Type','mod'=>'leoslideshow'),$_smarty_tpl);?>
</lable>
                            <select name="usevideo_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
" class="">
                                <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]=="0") {?>selected="selected"<?php }?> value="0"><?php echo smartyTranslate(array('s'=>'No','mod'=>'leoslideshow'),$_smarty_tpl);?>
</option>
                                <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]=="youtube") {?>selected="selected"<?php }?> value="youtube"><?php echo smartyTranslate(array('s'=>'Youtube','mod'=>'leoslideshow'),$_smarty_tpl);?>
</option>
                                <option <?php if (isset($_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']])&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]&&$_smarty_tpl->tpl_vars['fields_value']->value["usevideo"][$_smarty_tpl->tpl_vars['language']->value['id_lang']]=="vimeo") {?>selected="selected"<?php }?> value="vimeo"><?php echo smartyTranslate(array('s'=>'Vimeo','mod'=>'leoslideshow'),$_smarty_tpl);?>
</option>
                            </select>
                        </div>
                        <div class="radiolabel">
                            <lable><?php echo smartyTranslate(array('s'=>'Video ID','mod'=>'leoslideshow'),$_smarty_tpl);?>
</lable>
...
?>
        ...
        <input type="hidden" id="current_language" name="current_language" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_language']->value, ENT_QUOTES, 'UTF-8', true);?>
"/>
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='col_width') {?>
        <div class="col-lg-9">
            <input type='hidden' class="col-val <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true);?>
...
/12</span><span class="leo-width leo-w-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true);?>
...
"> </span>
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='group_class') {?>
        <div class="col-lg-9">
            <div class="well">
                <p> 
                    <input type="text" class="group-class" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']], ENT_QUOTES, 'UTF-8', true);?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
"/><br />
                    <?php echo smartyTranslate(array('s'=>'insert new or select classes for toggling content across viewport breakpoints','mod'=>'leoslideshow'),$_smarty_tpl);?>
<br />
                            ...
                            <div class="col-lg-6">
                                <div class="col-md-4">
                                    <a href="javascript:void(0)" class="btn btn-default btn-update-slider">
                                                <i class="icon-upload"></i> <?php echo smartyTranslate(array('s'=>'Select slider background','mod'=>'leoslideshow'),$_smarty_tpl);?>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                            <input type="color"
                                            data-hex="true"
                                            <?php if (isset($_smarty_tpl->tpl_vars['input']->value['class'])) {?>class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true);?>
"
...
<?php } else { ?>9<?php }?> <?php if (!isset($_smarty_tpl->tpl_vars['input']->value['label'])) {?>col-lg-offset-3<?php }?>">
			<span class="switch prestashop-switch fixed-width-lg <?php if (isset($_smarty_tpl->tpl_vars['input']->value['class'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>">
...
"<?php if ($_smarty_tpl->tpl_vars['value']->value['value']==1) {?> id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_on"<?php } else { ?> id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
"<?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['input']->value['name']]==$_smarty_tpl->tpl_vars['value']->value['value']) {?> checked="checked"<?php }?><?php if (isset($_smarty_tpl->tpl_vars['input']->value['disabled'])&&$_smarty_tpl->tpl_vars['input']->value['disabled']) {?> disabled="disabled"<?php }?>/>
				<label <?php if ($_smarty_tpl->tpl_vars['value']->value['value']==1) {?> for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_on"<?php } else { ?> for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_off"<?php }?>><?php if ($_smarty_tpl->tpl_vars['value']->value['value']==1) {?><?php echo smartyTranslate(array('s'=>'Yes','mod'=>'leoslideshow'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'No','mod'=>'leoslideshow'),$_smarty_tpl);?>
<?php }?></label>
				<?php } ?>
 ...
 $_from = $_smarty_tpl->tpl_vars['input']->value['leo_desc']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '35457285857d433c8168af1-73697622');
content_57d433c8b11781_35660701($_smarty_tpl);
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-09-10 12:24:40
         compiled from "/home/paris/public_html/parissara_com/iadmin/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_57d433c8b11781_35660701')) {function content_57d433c8b11781_35660701($_smarty_tpl) {?>
