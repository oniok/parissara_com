<?php /* Smarty version Smarty-3.1.19, created on 2016-09-11 00:53:22
         compiled from "/home/paris/public_html/parissara_com/modules/appagebuilder/views/templates/admin/_configure/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:104798818457d4e342731082-25503531%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c37ff67058a1b2407b7771ed4e3eb8e44542038a' => 
    array (
      0 => '/home/paris/public_html/parissara_com/modules/appagebuilder/views/templates/admin/_configure/helpers/form/form.tpl',
      1 => 1470921369,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '104798818457d4e342731082-25503531',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d4e343d58102_31099630',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d4e343d58102_31099630')) {function content_57d4e343d58102_31099630($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/paris/public_html/parissara_com/tools/smarty/plugins/function.counter.php';
...
if (!is_callable('smarty_function_math')) include '/home/paris/public_html/parissara_com/tools/smarty/plugins/function.math.php';
?>
...
?>
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='blockLink') {?>
		<div class="col-lg-9 cover-block-link">
			<div class="col-lg-1 fr"><button type="button" class="fr btn btn-warning btn-remove-block-link"><?php echo smartyTranslate(array('s'=>'Remove','mod'=>'appagebuilder'),$_smarty_tpl);?>
</button></div>
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['defaultFormLanguage']->value) {?>style="display:none"<?php }?>>
						...
						<div class="col-lg-1 <?php if (count($_smarty_tpl->tpl_vars['languages']->value)<=1) {?>hide<?php }?>">
...
?>
								<li><a href="javascript:hideOtherLanguage(<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['lang']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
...
-name').val(file[file.length-1]);
		...
		<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Link','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
...
?>
				...
				<script type="text/javascript">
					$(document).ready(function(){
						$('#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_link_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
-selectbutton').click(function(e){
							$('#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_link_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
').trigger('click');
...
?>
				<li role="presentation" class="<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['tabList']['first']) {?>active<?php }?>"><a href="#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8', true);?>
" class="aptab-config" role="tab" data-toggle="tab"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value, ENT_QUOTES, 'UTF-8', true);?>
</a></li>
			<?php } ?>
			</ul>
		</div>
...
?>
				<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
					<div class="translatable-field lang-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" data-lang="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['defaultFormLanguage']->value) {?>style="display:none"<?php }?>>
				<?php }?>
					<div class="col-lg-6">
						<?php if (isset($_smarty_tpl->tpl_vars['input']->value['show_image'])&&$_smarty_tpl->tpl_vars['input']->value['show_image']!=false) {?>
							...
							<img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['path_image']->value, ENT_QUOTES, 'UTF-8', true);?>
...
" class="img-thumbnail" data-img="">
							<?php }?>
						<?php }?>
						<a class="field-link choose-img <?php if (isset($_smarty_tpl->tpl_vars['input']->value['class'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['class'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" data-fancybox-type="iframe" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['href'], ENT_QUOTES, 'UTF-8', true);?>
" data-for="#<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
" type="text" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['language']->value['id_lang'], ENT_QUOTES, 'UTF-8', true);?>
...
'/>
			<div id="list_image_wrapper" style="display:none">
				<div class="list-image">
					<img id="apci" src="" class="hidden" path="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['path_image'], ENT_QUOTES, 'UTF-8', true);?>
" widget="ApCategoryImage"/>
					<a data-for="#apci" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['href_image'], ENT_QUOTES, 'UTF-8', true);?>
" class="apcategoryimage field-link choose-img"> [<?php echo smartyTranslate(array('s'=>'Select image','mod'=>'appagebuilder'),$_smarty_tpl);?>
	...
	<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='bg_img') {?>
		<div class="col-lg-9 ">
			<input type="text" name="bg_img" id="bg_img" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value['bg_img'], ENT_QUOTES, 'UTF-8', true);?>
" class="">
          <?php if (strpos($_smarty_tpl->tpl_vars['fields_value']->value['bg_img'],"/")!==false) {?>
              <img id="s-image"<?php if (!$_smarty_tpl->tpl_vars['fields_value']->value['bg_img']) {?> class="hidden"<?php }?> src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value['img_link'], ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value['bg_img'], ENT_QUOTES, 'UTF-8', true);?>
"/>
          <?php } else { ?>
              <img id="s-image"<?php if (!$_smarty_tpl->tpl_vars['fields_value']->value['bg_img']) {?> class="hidden"<?php }?> src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['img_link'], ENT_QUOTES, 'UTF-8', true);?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value['bg_img'], ENT_QUOTES, 'UTF-8', true);?>
"/>
          <?php }?>
			<div>
				<a class="choose-img" data-fancybox-type="iframe" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminApPageBuilderImages'), ENT_QUOTES, 'UTF-8', true);?>
&imgDir=images&is_ajax=true" data-for="#bg_img"><?php echo smartyTranslate(array('s'=>'Select image','mod'=>'appagebuilder'),$_smarty_tpl);?>
</a> -
		...
		<div class="">
			<div class="well">
				<div class="row">
				   ...
				   <label class="choise-class col-lg-12"><input type="checkbox" class="select-class" data-value="row" value="1"> <?php echo smartyTranslate(array('s'=>'Use class row','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
				   <?php }?>
				   <label class="control-label col-lg-1"><?php echo smartyTranslate(array('s'=>'Class:','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
					<div class="col-lg-11"><input type="text" class="element_class" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value['class'], ENT_QUOTES, 'UTF-8', true);?>
" name="class"></div>
				</div><br/>
...
<br>
				<ul class="ap-col-class">
					<li>
						<label class="choise-class"><input class="select-class" type="checkbox" data-value="hidden-lg" value="1"> <?php echo smartyTranslate(array('s'=>'Hidden in Large devices','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
					</li>
					<li>
						<label class="choise-class"><input class="select-class" type="checkbox" data-value="hidden-md" value="1"> <?php echo smartyTranslate(array('s'=>'Hidden in Medium devices','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
					</li>
					<li>    
						<label class="choise-class"><input class="select-class" type="checkbox" data-value="hidden-sm" value="1"> <?php echo smartyTranslate(array('s'=>'Hidden in Small devices','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
					</li>
					<li>
						<label class="choise-class"><input class="select-class" type="checkbox" data-value="hidden-xs" value="1"> <?php echo smartyTranslate(array('s'=>'Hidden in Extra small devices','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
					</li>
					<li>
						<label class="choise-class"><input class="select-class" type="checkbox" data-value="hidden-sp" value="1"> <?php echo smartyTranslate(array('s'=>'Hidden in Smart Phone','mod'=>'appagebuilder'),$_smarty_tpl);?>
</label>
					</li>
				</ul>
				</div>
...
?>
					<tr>
						<td>
							<span class="col-<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridKey']->value, ENT_QUOTES, 'UTF-8', true);?>
"></span>
							<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridValue']->value, ENT_QUOTES, 'UTF-8', true);?>

						</td>
						<td>
							<div class="btn-group">
								<input type='hidden' class="col-val" name='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridKey']->value, ENT_QUOTES, 'UTF-8', true);?>
' value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['gridKey']->value], ENT_QUOTES, 'UTF-8', true);?>
"/>
								<button type="button" class="btn btn-default apbtn-width dropdown-toggle" tabindex="-1" data-toggle="dropdown">
									<span class="width-val ap-w-<?php echo htmlspecialchars(smarty_modifier_replace($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['gridKey']->value],'.','-'), ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['gridKey']->value], ENT_QUOTES, 'UTF-8', true);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '104798818457d4e342731082-25503531');
content_57d4e3431cd8c9_71100737($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-09-11 00:53:23
         compiled from "/home/paris/public_html/parissara_com/iadmin/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_57d4e3431cd8c9_71100737')) {function content_57d4e3431cd8c9_71100737($_smarty_tpl) {?>
