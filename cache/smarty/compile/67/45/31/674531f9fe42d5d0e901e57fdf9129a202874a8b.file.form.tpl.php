<?php /* Smarty version Smarty-3.1.19, created on 2016-09-10 10:05:11
         compiled from "/home/paris/public_html/parissara_com/modules/appagebuilder/views/templates/admin/_configure/ap_page_builder_products/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:188491569957d413171aa017-75234288%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '674531f9fe42d5d0e901e57fdf9129a202874a8b' => 
    array (
      0 => '/home/paris/public_html/parissara_com/modules/appagebuilder/views/templates/admin/_configure/ap_page_builder_products/helpers/form/form.tpl',
      1 => 1470921433,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '188491569957d413171aa017-75234288',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d413186790e4_08297426',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d413186790e4_08297426')) {function content_57d413186790e4_08297426($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/paris/public_html/parissara_com/tools/smarty/plugins/function.counter.php';
?>
...
?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='ap_proGrid') {?>
        <div class="col-lg-9 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['input']->value['type'], ENT_QUOTES, 'UTF-8', true);?>
">
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    <div class="panel product-container">
                        <div class="desc-box">product-container</div>
                            <?php  $_smarty_tpl->tpl_vars['vblock'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['vblock']->_loop = false;
 $_smarty_tpl->tpl_vars['kBlock'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['input']->value['blockList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['vblock']->key => $_smarty_tpl->tpl_vars['vblock']->value) {
$_smarty_tpl->tpl_vars['vblock']->_loop = true;
 $_smarty_tpl->tpl_vars['kBlock']->value = $_smarty_tpl->tpl_vars['vblock']->key;
?>
                                <div class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vblock']->value, ENT_QUOTES, 'UTF-8', true);?>
">
                                    <div class="panel-heading"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vblock']->value, ENT_QUOTES, 'UTF-8', true);?>
</div>
                                    <div class="content <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['kBlock']->value, ENT_QUOTES, 'UTF-8', true);?>
-block-content">
                                    <?php $_smarty_tpl->tpl_vars['blockElement'] = new Smarty_variable($_smarty_tpl->tpl_vars['input']->value['params'][$_smarty_tpl->tpl_vars['kBlock']->value], null, 0);?>
                                    <?php  $_smarty_tpl->tpl_vars['gridElement'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['gridElement']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['blockElement']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['gridElement']->key => $_smarty_tpl->tpl_vars['gridElement']->value) {
$_smarty_tpl->tpl_vars['gridElement']->_loop = true;
?>
                                        <?php if ($_smarty_tpl->tpl_vars['gridElement']->value['name']=='functional_buttons') {?>
                                            <?php $_smarty_tpl->tpl_vars['iconVal'] = new Smarty_variable('icon-puzzle-piece', null, 0);?>
                                            <?php $_smarty_tpl->tpl_vars['NameVal'] = new Smarty_variable($_smarty_tpl->tpl_vars['gridElement']->value['name'], null, 0);?>
                                        <?php } elseif ($_smarty_tpl->tpl_vars['gridElement']->value['name']=='code') {?>
                                            <?php $_smarty_tpl->tpl_vars['iconVal'] = new Smarty_variable('icon-code', null, 0);?>
                                            <?php $_smarty_tpl->tpl_vars['NameVal'] = new Smarty_variable('code', null, 0);?>
                                        <?php } else { ?>
                                            <?php $_smarty_tpl->tpl_vars['iconVal'] = new Smarty_variable($_smarty_tpl->tpl_vars['input']->value['elements'][$_smarty_tpl->tpl_vars['gridElement']->value['name']]['icon'], null, 0);?>
                                            <?php $_smarty_tpl->tpl_vars['NameVal'] = new Smarty_variable($_smarty_tpl->tpl_vars['input']->value['elements'][$_smarty_tpl->tpl_vars['gridElement']->value['name']]['name'], null, 0);?>
                                        <?php }?>
                                        <div class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridElement']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
 plist-element" data-element='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridElement']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
'><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['iconVal']->value, ENT_QUOTES, 'UTF-8', true);?>
"></i> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['NameVal']->value, ENT_QUOTES, 'UTF-8', true);?>
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <a class="plist-eedit" data-element='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridElement']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
'><i class="icon-edit"></i></a>
                                            </div>
                                            <?php if ($_smarty_tpl->tpl_vars['gridElement']->value['name']=='functional_buttons') {?>
                                                <div class="content">
                                                    <?php if (isset($_smarty_tpl->tpl_vars['gridElement']->value['element'])) {?>
                                                    <?php  $_smarty_tpl->tpl_vars['gridSubElement'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['gridSubElement']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['gridElement']->value['element']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['gridSubElement']->key => $_smarty_tpl->tpl_vars['gridSubElement']->value) {
$_smarty_tpl->tpl_vars['gridSubElement']->_loop = true;
?>
                                                        <?php if ($_smarty_tpl->tpl_vars['gridSubElement']->value['name']=='code') {?>
                                                            <?php $_smarty_tpl->tpl_vars['iconVal'] = new Smarty_variable('icon-code', null, 0);?>
                                                            <?php $_smarty_tpl->tpl_vars['NameVal'] = new Smarty_variable('code', null, 0);?>
                                                        <?php } else { ?>
                                                            <?php $_smarty_tpl->tpl_vars['iconVal'] = new Smarty_variable($_smarty_tpl->tpl_vars['input']->value['elements'][$_smarty_tpl->tpl_vars['gridSubElement']->value['name']]['icon'], null, 0);?>
                                                            <?php $_smarty_tpl->tpl_vars['NameVal'] = new Smarty_variable($_smarty_tpl->tpl_vars['input']->value['elements'][$_smarty_tpl->tpl_vars['gridSubElement']->value['name']]['name'], null, 0);?>
                                                        <?php }?>
                                                        <div class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridSubElement']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
 plist-element" data-element='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridSubElement']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
'><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['iconVal']->value, ENT_QUOTES, 'UTF-8', true);?>
"></i> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['NameVal']->value, ENT_QUOTES, 'UTF-8', true);?>
                                                            ...
                                                            <div class="pull-right">
                                                                <a class="plist-eremove"><i class="icon-trash"></i></a>
                                                                <a class="plist-eedit" data-element='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gridSubElement']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
'><i class="icon-edit"></i></a>
                                                            </div>
                                                            <?php if ($_smarty_tpl->tpl_vars['gridSubElement']->value['name']=='code') {?>
                ...
                <div class="col-lg-4 col-md-4 element-list content">
                    <?php  $_smarty_tpl->tpl_vars['eItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['eItem']->_loop = false;
 $_smarty_tpl->tpl_vars['eKey'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['input']->value['elements']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['eItem']->key => $_smarty_tpl->tpl_vars['eItem']->value) {
$_smarty_tpl->tpl_vars['eItem']->_loop = true;
 $_smarty_tpl->tpl_vars['eKey']->value = $_smarty_tpl->tpl_vars['eItem']->key;
?>
                    <div class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['eKey']->value, ENT_QUOTES, 'UTF-8', true);?>
 plist-element" data-element='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['eKey']->value, ENT_QUOTES, 'UTF-8', true);?>
'><i class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['eItem']->value['icon'], ENT_QUOTES, 'UTF-8', true);?>
"></i> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['eItem']->value['name'], ENT_QUOTES, 'UTF-8', true);?>

                        <div class="pull-right">
                            <a class="plist-eremove"><i class="icon-trash"></i></a>
                            <a class="plist-eedit" data-element='<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['eKey']->value, ENT_QUOTES, 'UTF-8', true);?>
'><i class="icon-edit"></i></a>
                        </div>
                    </div>
                    <?php } ?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '188491569957d413171aa017-75234288');
content_57d41318353587_21039075($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2016-09-10 10:05:12
         compiled from "/home/paris/public_html/parissara_com/iadmin/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_57d41318353587_21039075')) {function content_57d41318353587_21039075($_smarty_tpl) {?>
