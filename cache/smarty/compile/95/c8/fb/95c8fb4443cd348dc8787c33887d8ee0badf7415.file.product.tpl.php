<?php /* Smarty version Smarty-3.1.19, created on 2016-09-18 17:29:52
         compiled from "/home/paris/public_html/parissara_com/themes/leo_mode/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:180512404157df0750764223-83857806%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95c8fb4443cd348dc8787c33887d8ee0badf7415' => 
    array (
      0 => '/home/paris/public_html/parissara_com/themes/leo_mode/product.tpl',
      1 => 1470919438,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '180512404157df0750764223-83857806',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57df0751516444_01878951',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57df0751516444_01878951')) {function content_57df0751516444_01878951($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/paris/public_html/parissara_com/tools/smarty/plugins/modifier.date_format.php';
			...
			<div id="image-block" class="clearfix">
				<div class="p-label">
					<?php if ($_smarty_tpl->tpl_vars['product']->value->new) {?>					
						<span class="label-new label label-info"><?php echo smartyTranslate(array('s'=>'New'),$_smarty_tpl);?>
</span>					
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale) {?>					
						<span class="label-sale label label-warning"><?php echo smartyTranslate(array('s'=>'Sale!'),$_smarty_tpl);?>
</span>					
...
" data-id="resetImages">
		...
		<!-- end left infos-->
		<!-- center infos -->
		<div class="pb-center-column col-xs-12 col-sm-12 col-md-7 col-lg-6">
...
</span><meta itemprop="priceCurrency" content="<?php echo $_smarty_tpl->tpl_vars['currency']->value->iso_code;?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->unity, ENT_QUOTES, 'UTF-8', true);?>
							...
							<?php if (!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
								<p id="quantity_wanted_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
									...
									<input type="number" min="1" name="qty" id="quantity_wanted" class="text form-control" value="<?php if (isset($_smarty_tpl->tpl_vars['quantityBackup']->value)) {?><?php echo intval($_smarty_tpl->tpl_vars['quantityBackup']->value);?>
...
<?php }?></span>
						...
						<div class="group-btn">
							<div class="compare">
								<a class="add_to_compare buttons_bottom_block" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('products-comparison'), ENT_QUOTES, 'UTF-8', true);?>
...
" >
									<i class="material-icons">playlist_add</i> <span><?php echo smartyTranslate(array('s'=>'Add to compare'),$_smarty_tpl);?>
</span>
								</a>
							</div>
...
<?php }?>
	...
	<?php if (!$_smarty_tpl->tpl_vars['content_only']->value) {?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['USE_PTABS']->value)&&$_smarty_tpl->tpl_vars['USE_PTABS']->value) {?>
			<div class="clearfix more_info_block"><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./sub/product_info/tab.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
</div>
		<?php } else { ?>
			<div class="clearfix more_info_default"><?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./sub/product_info/default.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
</div>
		<?php }?>
