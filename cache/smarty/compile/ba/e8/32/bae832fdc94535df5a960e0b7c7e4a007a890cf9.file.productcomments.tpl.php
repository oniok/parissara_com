<?php /* Smarty version Smarty-3.1.19, created on 2016-09-18 17:29:52
         compiled from "/home/paris/public_html/parissara_com/themes/leo_mode/modules/productcomments//productcomments.tpl" */ ?>
<?php /*%%SmartyHeaderCode:70182233357df07501615f9-38539525%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bae832fdc94535df5a960e0b7c7e4a007a890cf9' => 
    array (
      0 => '/home/paris/public_html/parissara_com/themes/leo_mode/modules/productcomments//productcomments.tpl',
      1 => 1470920069,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '70182233357df07501615f9-38539525',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57df0750278c98_19996723',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57df0750278c98_19996723')) {function content_57df0750278c98_19996723($_smarty_tpl) {?>
				...
				<div class="comment row" itemprop="review" itemscope itemtype="https://schema.org/Review">
					<div class="comment_author col-sm-2">
						<div itemprop="itemReviewed" itemscope itemtype="https://schema.org/Restaurant">
							<span itemprop="name"><?php echo smartyTranslate(array('s'=>'Grade','mod'=>'productcomments'),$_smarty_tpl);?>
&nbsp;</span>
						</div>
						...
						<div class="comment_author_infos">
							<div itemprop="author" itemscope itemtype="https://schema.org/Person">
								<strong itemprop="name">
									<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comment']->value['customer_name'], ENT_QUOTES, 'UTF-8', true);?>
						...
						<ul>
							...
							<?php if ($_smarty_tpl->tpl_vars['is_logged']->value) {?>
								...
								<li>
									...
									<button class="usefulness_btn btn btn-outline button button-small btn-sm" data-is-usefull="1" data-id-product-comment="<?php echo $_smarty_tpl->tpl_vars['comment']->value['id_product_comment'];?>
">
										<span><?php echo smartyTranslate(array('s'=>'Yes','mod'=>'productcomments'),$_smarty_tpl);?>
</span>
									</button>
									<button class="usefulness_btn btn btn-outline button button-small btn-sm" data-is-usefull="0" data-id-product-comment="<?php echo $_smarty_tpl->tpl_vars['comment']->value['id_product_comment'];?>
">
		...
		<form id="id_new_comment_form" action="#">
			...
			<div class="row">
				<?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value) {?>
					<?php if (isset($_smarty_tpl->tpl_vars['product']->value->name)) {?>
						<?php $_smarty_tpl->tpl_vars["productName"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value->name, null, 0);?>
						<?php $_smarty_tpl->tpl_vars["productDes"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value->description_short, null, 0);?>
					<?php } elseif (isset($_smarty_tpl->tpl_vars['product']->value['name'])) {?>
						<?php $_smarty_tpl->tpl_vars["productName"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['name'], null, 0);?>
						<?php $_smarty_tpl->tpl_vars["productDes"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['description_short'], null, 0);?>
					<?php } else { ?>
						<?php $_smarty_tpl->tpl_vars["productName"] = new Smarty_variable('', null, 0);?>
						<?php $_smarty_tpl->tpl_vars["productDes"] = new Smarty_variable('', null, 0);?>
					<?php }?>
					<div class="product clearfix  col-xs-12 col-sm-6">
						<img src="<?php echo $_smarty_tpl->tpl_vars['productcomment_cover_image']->value;?>
" height="<?php echo $_smarty_tpl->tpl_vars['mediumSize']->value['height'];?>
" width="<?php echo $_smarty_tpl->tpl_vars['mediumSize']->value['width'];?>
" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['productName']->value, ENT_QUOTES, 'UTF-8', true);?>
" />
						<div class="product_desc">
							<p class="product_name">
								<strong><?php echo $_smarty_tpl->tpl_vars['productName']->value;?>
</strong>
							</p>
							<?php echo $_smarty_tpl->tpl_vars['productDes']->value;?>
