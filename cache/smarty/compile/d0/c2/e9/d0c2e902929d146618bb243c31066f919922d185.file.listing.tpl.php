<?php /* Smarty version Smarty-3.1.19, created on 2016-09-18 17:34:49
         compiled from "/home/paris/public_html/parissara_com/themes/leo_mode/modules/leoblog/views/templates/front/default/listing.tpl" */ ?>
<?php /*%%SmartyHeaderCode:150343930557df08791fea43-43808237%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0c2e902929d146618bb243c31066f919922d185' => 
    array (
      0 => '/home/paris/public_html/parissara_com/themes/leo_mode/modules/leoblog/views/templates/front/default/listing.tpl',
      1 => 1470921366,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '150343930557df08791fea43-43808237',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57df0879320b92_75662592',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57df0879320b92_75662592')) {function content_57df0879320b92_75662592($_smarty_tpl) {?>
...
<div id="blog-listing" class="blogs-container box">
 	<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['type'])) {?>
	 	<?php if ($_smarty_tpl->tpl_vars['filter']->value['type']=='tag') {?>
			<h1><?php echo smartyTranslate(array('s'=>'Filter Blogs By Tag','mod'=>'leoblog'),$_smarty_tpl);?>
 : <span><?php echo $_smarty_tpl->tpl_vars['filter']->value['tag'];?>
</span></h1>
		<?php } elseif ($_smarty_tpl->tpl_vars['filter']->value['type']=='author') {?>
			<h1><?php echo smartyTranslate(array('s'=>'Filter Blogs By Blogger','mod'=>'leoblog'),$_smarty_tpl);?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['filter']->value['employee']->lastname;?>
		...
		<?php }?>
	<?php } else { ?>
	<h1><?php echo smartyTranslate(array('s'=>'Lastest Blogs','mod'=>'leoblog'),$_smarty_tpl);?>
</h1>
	<?php }?>
