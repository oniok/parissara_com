<?php /* Smarty version Smarty-3.1.19, created on 2016-09-16 15:56:57
         compiled from "/home/paris/public_html/parissara_com/themes/leo_mode/order-steps.tpl" */ ?>
<?php /*%%SmartyHeaderCode:169434078557dc4e89a46fd5-20540432%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b69bf8170c2186a1a721f2a28810a80d0dceba19' => 
    array (
      0 => '/home/paris/public_html/parissara_com/themes/leo_mode/order-steps.tpl',
      1 => 1470919437,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169434078557dc4e89a46fd5-20540432',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57dc4e89b118e2_12114856',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57dc4e89b118e2_12114856')) {function content_57dc4e89b118e2_12114856($_smarty_tpl) {?>
...
<ul class="step clearfix" id="order_step">
	<li class="col-md-2-4 col-xs-12 <?php if ($_smarty_tpl->tpl_vars['current_step']->value=='summary') {?>step_current <?php } elseif ($_smarty_tpl->tpl_vars['current_step']->value=='login') {?>step_done_last step_done<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment'||$_smarty_tpl->tpl_vars['current_step']->value=='shipping'||$_smarty_tpl->tpl_vars['current_step']->value=='address'||$_smarty_tpl->tpl_vars['current_step']->value=='login') {?>step_done<?php } else { ?>step_todo<?php }?><?php }?> first">
...
">
	...
	<li class="col-md-2-4 col-xs-12 <?php if ($_smarty_tpl->tpl_vars['current_step']->value=='login') {?>step_current<?php } elseif ($_smarty_tpl->tpl_vars['current_step']->value=='address') {?>step_done step_done_last<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment'||$_smarty_tpl->tpl_vars['current_step']->value=='shipping'||$_smarty_tpl->tpl_vars['current_step']->value=='address') {?>step_done<?php } else { ?>step_todo<?php }?><?php }?> second">
...
">
	...
	<li class="col-md-2-4 col-xs-12 <?php if ($_smarty_tpl->tpl_vars['current_step']->value=='address') {?>step_current<?php } elseif ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_done step_done_last<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment'||$_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_done<?php } else { ?>step_todo<?php }?><?php }?> third">
...
">
	...
	<li class="col-md-2-4 col-xs-12 <?php if ($_smarty_tpl->tpl_vars['current_step']->value=='shipping') {?>step_current<?php } else { ?><?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_done step_done_last<?php } else { ?>step_todo<?php }?><?php }?> four">
...
">
	...
	<li id="step_end" class="col-md-2-4 col-xs-12 <?php if ($_smarty_tpl->tpl_vars['current_step']->value=='payment') {?>step_current<?php } else { ?>step_todo<?php }?> last">
