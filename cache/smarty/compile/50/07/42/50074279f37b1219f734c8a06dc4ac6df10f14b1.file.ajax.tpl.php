<?php /* Smarty version Smarty-3.1.19, created on 2016-09-10 12:23:15
         compiled from "/home/paris/public_html/parissara_com/modules/leoslideshow/views/templates/admin/helpers/uploader/ajax.tpl" */ ?>
<?php /*%%SmartyHeaderCode:192681626457d4337334d179-10408402%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50074279f37b1219f734c8a06dc4ac6df10f14b1' => 
    array (
      0 => '/home/paris/public_html/parissara_com/modules/leoslideshow/views/templates/admin/helpers/uploader/ajax.tpl',
      1 => 1470921331,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '192681626457d4337334d179-10408402',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57d433736017b5_62833035',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d433736017b5_62833035')) {function content_57d433736017b5_62833035($_smarty_tpl) {?>
...
?>
		...
		<div class="img-thumbnail text-center">
			...
			<?php if (isset($_smarty_tpl->tpl_vars['file']->value['size'])) {?><p><?php echo smartyTranslate(array('s'=>'File size','mod'=>'leoslideshow'),$_smarty_tpl);?>
...
<div class="row">
	<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'You have reached the limit (%s) of files to upload, please remove files to continue uploading','mod'=>'leoslideshow','sprintf'=>$_smarty_tpl->tpl_vars['max_files']->value),$_smarty_tpl);?>
</div>
</div>
...
-add-button">
			<i class="icon-plus-sign"></i> <?php if (isset($_smarty_tpl->tpl_vars['multiple']->value)&&$_smarty_tpl->tpl_vars['multiple']->value) {?><?php echo smartyTranslate(array('s'=>'Add files','mod'=>'leoslideshow'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Add file','mod'=>'leoslideshow'),$_smarty_tpl);?>
<?php }?>
		</button>
...
-upload-button" style="display:none;">
			<i class="icon-cloud-upload text-success"></i> <span class="ladda-label text-success"><?php if (isset($_smarty_tpl->tpl_vars['multiple']->value)&&$_smarty_tpl->tpl_vars['multiple']->value) {?><?php echo smartyTranslate(array('s'=>'Upload files','mod'=>'leoslideshow'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Upload file','mod'=>'leoslideshow'),$_smarty_tpl);?>
<?php }?></span>
		</button>
                <!-- Split button -->
                <div class="btn-group">
                <button class="btn btn-default btn-sm dropdown-toggle" type="button" data-toggle="dropdown">
                  <?php echo smartyTranslate(array('s'=>'Order Image By','mod'=>'leoslideshow'),$_smarty_tpl);?>
 <span class="caret"></span>
                </button>
                <ul id="img_order" class="dropdown-menu">
                    <li><a href="#" data-type="name"><span class="text-danger"><?php echo smartyTranslate(array('s'=>'Name','mod'=>'leoslideshow'),$_smarty_tpl);?>
 <i class="icon-sort-by-alphabet"></i></span></a></li>
                    <li><a href="#" data-type="name_desc"><span><?php echo smartyTranslate(array('s'=>'Name DESC','mod'=>'leoslideshow'),$_smarty_tpl);?>
 <i class="icon-sort-by-alphabet-alt"></i></span></a></li>
                    <li class="divider"></li>
                    <li><a href="#" data-type="date"><span><?php echo smartyTranslate(array('s'=>'Date Modified','mod'=>'leoslideshow'),$_smarty_tpl);?>
 <i class="icon-sort-by-attributes"></i></span></a></li>
                    <li><a href="#" data-type="date_desc"><span><?php echo smartyTranslate(array('s'=>'Date Modified DESC','mod'=>'leoslideshow'),$_smarty_tpl);?>
...
_max_files) {
					e.preventDefault();
					alert('<?php echo smartyTranslate(array('s'=>sprintf('You can upload a maximum of %s files',$_smarty_tpl->tpl_vars['max_files']->value),'mod'=>'leoslideshow'),$_smarty_tpl);?>
');
					return;
				}
			}
...
-files-list'));
			...
			var button = $('<button/>').addClass('btn btn-default pull-right').prop('type', 'button').html('<i class="icon-trash"></i> <?php echo smartyTranslate(array('s'=>'Remove file','mod'=>'leoslideshow'),$_smarty_tpl);?>
