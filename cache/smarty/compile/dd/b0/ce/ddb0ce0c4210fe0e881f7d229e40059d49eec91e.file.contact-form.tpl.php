<?php /* Smarty version Smarty-3.1.19, created on 2016-09-29 22:56:31
         compiled from "C:\xampp\htdocs\parissara_com\themes\leo_mode\contact-form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1398157ed39af505a52-96102019%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ddb0ce0c4210fe0e881f7d229e40059d49eec91e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\parissara_com\\themes\\leo_mode\\contact-form.tpl',
      1 => 1475079138,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1398157ed39af505a52-96102019',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ed39afa555a1_13786676',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ed39afa555a1_13786676')) {function content_57ed39afa555a1_13786676($_smarty_tpl) {?>
...
<h4 style="text-transform: none;line-height: 1.4;padding-bottom: 10px;">
	...
	<?php echo smartyTranslate(array('s'=>'We want to serve you better than the best. Let us know about your shopping experience at PARISSARA, '),$_smarty_tpl);?>

	</span>
	<span id="txt_contact_2">
	<?php echo smartyTranslate(array('s'=>'shoot us a question, or fire over a comment, and we\'ll get back to you.'),$_smarty_tpl);?>
...
" class="desc_contact contact-title<?php if (!isset($_REQUEST['id_contact'])||intval($_REQUEST['id_contact'])!=intval($_smarty_tpl->tpl_vars['contact']->value['id_contact'])) {?> unvisible<?php }?>">
								<i class="fa fa-comment-alt"></i><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['contact']->value['description'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?></textarea>
			...
			<div class="submit">
				<button type="submit" name="submitMessage" id="submitMessage" class="button btn btn-outline button-medium"><span><?php echo smartyTranslate(array('s'=>'Send'),$_smarty_tpl);?>
</span></button>
			</div>
		</fieldset>
		<div id="contact_info">
			<h5 style="text-transform: none;"><?php echo smartyTranslate(array('s'=>'contact@parissara.com'),$_smarty_tpl);?>
</h5>
			<h5 style="text-transform: none;"><?php echo smartyTranslate(array('s'=>'+66 (0) 82 333 2293'),$_smarty_tpl);?>
</h5>			
			<h5 style="text-transform: none;"><a target="_blank" href="https://www.facebook.com/parissaraofficial" class="btn-tooltip" data-original-title="Facebook"> <span><?php echo smartyTranslate(array('s'=>'facbook.com/parissaraofficial'),$_smarty_tpl);?>
</span> </a></h5>
			<h5 style="text-transform: none;"><a target="_blank" href="https://www.instagram.com/parissaraofficial/" class="btn-tooltip" data-original-title="instagram"><span><?php echo smartyTranslate(array('s'=>'ig: parissaraofficial'),$_smarty_tpl);?>
</span> </a></h5>
			<h5 style="text-transform: none;"><?php echo smartyTranslate(array('s'=>'pinterest: parissara'),$_smarty_tpl);?>
</h5>
			<h5 style="text-transform: none;"><?php echo smartyTranslate(array('s'=>'twitter: parissara_'),$_smarty_tpl);?>
</h5>
		</div>
	</form>
<?php }?>
