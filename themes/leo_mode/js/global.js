...
$(document).ready(function(){
	...
	/* Check has class */
	if ($(".top .row").hasClass("sidebar-fix")) {
        $("#page").addClass('sliderbar-menu-margin');
    }
...
function newsletter_block_left(){
	$("#newsletter_block_left .icon_newsletter").click(function () {
		if(!$("#newsletter_block_left .block_content").hasClass('active'))
		{
			$("#newsletter_block_left .block_content").addClass('active');
		}
		else
		{
			$("#newsletter_block_left .block_content").removeClass('active');
		}
