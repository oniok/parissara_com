...
{addJsDef productcompare_url=$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}
{addJsDefL name=productcompare_remove}{l s='The product was successfully removed from list compare' js=1}{/addJsDefL}
{addJsDefL name=productcompare_add}{l s='The product has been added to list compare' js=1}{/addJsDefL}
{addJsDefL name=productcompare_viewlistcompare}{l s='View list compare' js=1}{/addJsDefL}
{/strip}