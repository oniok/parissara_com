...
<div class="blockcart_top pull-right{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
		...
		<div class="heading">
			<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
				...
				<div class="cart-inner media-body">
					<h4>{l s='My Cart' mod='blockcart'}</h4> 
					<span class="ajax_cart_quantity{if $cart_qties == 0} unvisible{/if}">{$cart_qties}</span>
		...
		<div class="clearfix">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="button-container">	
					...
					<a class="btn btn-outline button pull-right" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
						<span>
